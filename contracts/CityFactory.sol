...
contract CityFactory {
    ...
    function createDistrictFactory(
        ...
        accessControlManager.createNewContract(
            _district_name, 
            _owner_name, 
            address(new DistrictFactory(address(accessControlManager))), 
            AccessControlManager.ContractType.distictfactory, 
            _parent_address, 
            _parent_name, 
            _data, 
            _signature);
